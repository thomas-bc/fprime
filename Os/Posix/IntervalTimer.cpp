// ======================================================================
// \title Os/Posix/IntervalTimer.cpp
// \brief Posix implementation for Os::IntervalTimer
// ======================================================================
...
void PosixIntervalTimer::getRawTime(RawTime& time) {
    timespec t;
...
// should be t1In - t2In
U32 PosixIntervalTimer::getDiffUsec(const RawTime& t1In, const RawTime& t2In) {
...
IntervalTimerHandle* PosixIntervalTimer::getHandle() {
